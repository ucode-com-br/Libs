...
using UCode.DeepCloning.SpecializedCloners;
...
namespace UCode.DeepCloning
{
    ...
    {
        internal static readonly CloneObjectDelegate<T> CloneObject;
        internal static readonly ConcurrentDictionary<Type, CloneObjectDelegate> Redirects = new();
        internal static readonly Type DeclaredType = typeof(T);
        ...
        private
#endif
        static T CloneSimpleType(T value, Dictionary<object, object> reusableClones, DeepCloningOptions options) => value;
        ...
        static T CloneObjectType(T value, Dictionary<object, object> reusableClones, DeepCloningOptions options)
        {
            ...
            {
                if (IsSimpleValueType(actualType))
                {
                    return value;
                }
            }
